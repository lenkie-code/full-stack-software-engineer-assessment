# Lenkie Full Stack Software Engineer Assessment
...
- Use this opportunity to showcase your understanding of software architecture using .NET Core/Node.JS for your backend and either Vue.JS or React.JS on the frontend
